local customplayers = {
	...
	{"Number K | Professional", "models/player/custom_player/legacy/tm_professional_vari.mdl", true},
...
for i=1, #teams do
	...
	team_references[is_t] = {
		enabled_reference = ui.new_checkbox("lua", "b", "Override player model\n" .. teamname),
		model_reference = ui.new_listbox("lua", "b", "Selected player model\n" .. teamname, "-", unpack(model_names))
	}
